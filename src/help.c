...
_("mtPaint 3.31 - Copyright (C) 2004-2009 The Authors\n"),
...
_("French - Nicolas Velin, Pascal Billard, Sylvain Cresto, Johan Serre, Plume"),
...
_("Swedish - Daniel Nylander, Fredrik Forsmo"),
